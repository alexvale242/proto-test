...
<section class="mock-controls__container">
    <div>
        <button class="eds-button eds-button--prominent" on:click={addStep}
            >Add step</button
        >
        <button class="eds-button" on:click={saveSteps}
            >Update steps</button
        >
    </div>
    <div class="workflow-steps__container">
